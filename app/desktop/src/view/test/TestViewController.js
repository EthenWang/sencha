Ext.define('MyApp.view.home.TestViewController', {
    ...
    testFunc: function() {
        Ext.Deferred.resolved().then(() => console.log('ext promise then deferred testFunc'));
        Promise.resolve().then(() => console.log('promise then testFunc'));
        Ext.Promise.resolve().then(() => console.log('ext promise then testFunc'));
